...
func_02014F80: @ 0x02014F80
	push {r4, lr}
	ldr r2, .L02014FF8 @ =gUnk_Sio_02018648
	ldr r0, [r2]
	movs r4, #0
	strb r4, [r0]
	ldr r0, [r2]
...
.L02014FDE:
	...
	bx r0
	.align 2, 0
.L02014FF8: .4byte gUnk_Sio_02018648
...
func_common_02014FE8: @ 0x02015010
	...
	strh r3, [r0]
	ldr r2, .L02015074 @ =gUnk_Sio_03001C34
	ldr r1, .L02015078 @ =0x03001C38
	movs r0, #0
	str r0, [r1]
	str r0, [r2]
	ldr r1, .L0201507C @ =gSioStateId
	str r0, [r1]
...
.L02015074: .4byte gUnk_Sio_03001C34
.L02015078: .4byte 0x03001C38
.L0201507C: .4byte gSioStateId
...
func_common_02015064: @ 0x0201508C
	...
	movs r0, #0
	strh r0, [r1]
	ldr r2, .L020150D4 @ =gUnk_Sio_03001C34
	ldr r1, .L020150D8 @ =0x03001C38
	movs r0, #0
	str r0, [r1]
	str r0, [r2]
	ldr r1, .L020150DC @ =gSioStateId
	str r0, [r1]
...
.L020150D4: .4byte gUnk_Sio_03001C34
.L020150D8: .4byte 0x03001C38
.L020150DC: .4byte gSioStateId
...
func_common_020150C4: @ 0x020150EC
	...
	movs r0, #0
	mov sb, r0
	ldr r0, .L02015180 @ =gUnk_Sio_03001C34
	movs r2, #1
	str r2, [r0]
	ldr r1, .L02015184 @ =gUnk_Sio_02018648
	ldr r0, [r1]
	mov r3, sb
	strb r3, [r0, #0x1e]
...
.L02015156:
	...
	cmp r0, sl
	beq .L020151A4
	ldr r2, .L02015184 @ =gUnk_Sio_02018648
	ldr r0, [r2]
	adds r0, #0xb
	adds r1, r0, r5
	ldrb r0, [r1]
...
.L02015172:
	...
	b .L020151DE
	.align 2, 0
.L02015180: .4byte gUnk_Sio_03001C34
.L02015184: .4byte gUnk_Sio_02018648
...
.L020151A4:
	...
	cmp r0, #1
	bne .L020151DE
	ldr r0, .L020151D0 @ =gUnk_Sio_02018648
	ldr r1, [r0]
	adds r0, r1, #0
	adds r0, #0x12
	adds r0, r0, r7
	...
	b .L020151DE
	.align 2, 0
.L020151D0: .4byte gUnk_Sio_02018648
.L020151D4:
	adds r0, r1, #0
	adds r0, #0x1a
	adds r0, r0, r5
	...
	strb r1, [r0]
.L020151DE:
	ldr r0, .L02015234 @ =gUnk_Sio_02018648
	mov r8, r0
	ldr r6, [r0]
	adds r3, r6, #0
	adds r3, #0x12
	...
	b .L02015310
	.align 2, 0
.L02015234: .4byte gUnk_Sio_02018648
...
.L020152F6:
	...
	cmp r3, #0
	bne .L02015310
	ldr r0, .L02015330 @ =gUnk_Sio_02018648
	ldr r0, [r0]
...
.L02015330: .4byte gUnk_Sio_02018648
...
func_common_02015438: @ 0x02015460
	push {r4, r5, r6, lr}
	sub sp, #4
	ldr r0, .L0201549C @ =gUnk_Sio_02018648
	ldr r2, [r0]
	ldrh r1, [r2, #4]
	adds r5, r0, #0
	cmp r1, #4
...
.L0201547A:
	...
	b .L02015508
	.align 2, 0
.L0201549C: .4byte gUnk_Sio_02018648
.L020154A0:
	cmp r0, #3
	bne .L02015508
	ldrb r0, [r1, #0x1e]
...
.L020154BA:
	ldr r4, .L0201552C @ =gUnk_Sio_02018648
	ldr r0, [r4]
	ldrb r0, [r0, #1]
	cmp r0, #0
	beq .L020154E0
...
.L020154E0:
	movs r4, #0
	ldr r5, .L0201552C @ =gUnk_Sio_02018648
.L020154E4:
	ldr r0, .L0201552C @ =gUnk_Sio_02018648
	ldr r1, [r0]
	adds r0, r1, #0
	adds r0, #0x1a
	adds r0, r0, r4
...
.L02015508:
	...
	b .L020155A0
	.align 2, 0
.L0201552C: .4byte gUnk_Sio_02018648
.L02015530:
	mov r0, sp
	...
	strb r6, [r0]
.L0201555E:
	ldr r2, .L02015578 @ =gUnk_Sio_02018648
	ldr r1, [r2]
	ldrb r0, [r1, #0x10]
	adds r0, #1
	strb r0, [r1, #0x10]
	...
	b .L020155A0
	.align 2, 0
.L02015578: .4byte gUnk_Sio_02018648
.L0201557C:
	subs r0, #2
	lsls r0, r0, #0x18
	lsrs r0, r0, #0x18
...
func_common_020155AC: @ 0x020155D4
	...
	movs r4, #0x38
.L020155DE:
	ldr r5, .L020156E0 @ =gUnk_Sio_02018648
	ldr r0, [r5]
	lsls r1, r6, #1
	adds r0, #0x26
	adds r0, r0, r1
...
.L020156B4:
	asrs r0, r7, #0x18
	ldr r4, .L020156E0 @ =gUnk_Sio_02018648
	ldr r1, [r4]
	adds r1, #0x32
	bl func_06_02015C5C
	lsls r0, r0, #0x10
...
.L020156DA:
	...
	b .L020159BE
	.align 2, 0
.L020156E0: .4byte gUnk_Sio_02018648
...
.L02015706:
	...
	b .L020159BE
.L0201570C:
	ldr r5, .L02015760 @ =gUnk_Sio_02018648
	ldr r2, [r5]
	adds r4, r2, #0
	adds r4, #0x32
	ldrb r0, [r4]
...
.L0201572C:
	...
	b .L020156B4
	.align 2, 0
.L02015760: .4byte gUnk_Sio_02018648
...
.L020157B0:
	...
	bne .L020157E0
.L020157BE:
	ldr r0, .L020157D8 @ =gUnk_Sio_02018648
	ldr r2, [r0]
	movs r0, #6
	ldrsb r0, [r2, r0]
	cmp r0, #0
...
.L020157CC:
	...
	b .L02015800
	.align 2, 0
.L020157D8: .4byte gUnk_Sio_02018648
.L020157DC: .4byte 0x03002E50
.L020157E0:
	ldr r0, .L0201580C @ =gUnk_Sio_02018648
	ldr r1, [r0]
	movs r0, #6
	ldrsb r0, [r1, r0]
	cmp r0, #0
...
.L02015804:
	...
	b .L020159BE
	.align 2, 0
.L0201580C: .4byte gUnk_Sio_02018648
...
.L02015860:
	ldr r0, .L02015874 @ =gUnk_Sio_02018648
	ldr r2, [r0]
	movs r0, #1
	ldrb r5, [r5, #1]
	lsls r0, r5
	...
	b .L020159BE
	.align 2, 0
.L02015874: .4byte gUnk_Sio_02018648
.L02015878:
	ldr r6, .L02015914 @ =gUnk_Sio_02018648
	ldr r3, [r6]
	adds r0, r3, #0
	adds r0, #0x2e
	ldrb r0, [r0]
...
.L020158B0:
	...
	b .L020159BE
	.align 2, 0
.L02015914: .4byte gUnk_Sio_02018648
...
.L02015920:
	...
	cmp r0, #0
	bne .L020159BE
	ldr r4, .L0201595C @ =gUnk_Sio_02018648
	ldr r0, [r4]
	movs r1, #6
	ldrsb r1, [r0, r1]
	adds r0, #0xb
	...
	b .L0201597C
	.align 2, 0
.L0201595C: .4byte gUnk_Sio_02018648
.L02015960:
	ldrb r0, [r5, #2]
	bl func_common_0201592C
	lsls r0, r0, #0x18
	cmp r0, #0
	bne .L020159BE
	ldr r2, .L02015984 @ =gUnk_Sio_02018648
	ldr r0, [r2]
	adds r0, #0xb
	ldrh r5, [r5, #2]
	adds r0, r0, r5
...
.L0201597C:
	...
	b .L020159BE
	.align 2, 0
.L02015984: .4byte gUnk_Sio_02018648
.L02015988:
	ldr r3, .L020159B4 @ =gUnk_Sio_02018648
	ldr r1, [r3]
	adds r1, #0xb
	ldrh r0, [r5, #2]
	adds r1, r1, r0
	...
	b .L020159BE
	.align 2, 0
.L020159B4: .4byte gUnk_Sio_02018648
.L020159B8:
	ldrb r0, [r5, #1]
...
func_common_0201592C: @ 0x02015A2C
	lsls r0, r0, #0x18
	lsrs r0, r0, #0x18
	ldr r1, .L02015A44 @ =gUnk_Sio_02018648
	ldr r1, [r1]
	ldrb r1, [r1, #9]
	asrs r1, r0
	movs r0, #1
	...
	b .L02015A4A
	.align 2, 0
.L02015A44: .4byte gUnk_Sio_02018648
.L02015A48:
	movs r0, #1
.L02015A4A:
	bx lr
...
func_common_0201594C: @ 0x02015A4C
	lsls r0, r0, #0x18
	lsrs r0, r0, #0x18
	ldr r1, .L02015A64 @ =gUnk_Sio_02018648
	ldr r1, [r1]
	ldrb r1, [r1, #8]
	asrs r1, r0
	movs r0, #1
	...
	b .L02015A6A
	.align 2, 0
.L02015A64: .4byte gUnk_Sio_02018648
.L02015A68:
	movs r0, #1
.L02015A6A:
	bx lr
...
func_common_0201596C: @ 0x02015A6C
	push {r4, lr}
	ldr r2, .L02015A98 @ =gUnk_Sio_02018648
	ldr r3, [r2]
	ldrh r1, [r3, #2]
	movs r0, #0
	strh r0, [r3, #2]
	...
	b .L02015AA8
	.align 2, 0
.L02015A98: .4byte gUnk_Sio_02018648
...
func_common_020159C0: @ 0x02015AC0
	ldr r0, .L02015ADC @ =gUnk_Sio_02018648
	ldr r0, [r0]
	...
	b .L02015AEC
	.align 2, 0
.L02015ADC: .4byte gUnk_Sio_02018648
...
func_06_02015AF0: @ 0x02015AF0
	...
	movs r4, #0
	movs r1, #0
	ldr r5, .L02015B58 @ =gUnk_Sio_02018648
	ldr r0, [r5]
	adds r2, r0, #0
	adds r2, #0xb
.L02015AFE:
...
.L02015B54:
	...
	b .L02015B5E
	.align 2, 0
.L02015B58: .4byte gUnk_Sio_02018648
.L02015B5C:
	movs r0, #0
.L02015B5E:
	pop {r4, r5}
...
func_common_02015CEC: @ 0x02015E74
	push {r4, lr}
	adds r4, r0, #0
	ldr r0, .L02015E8C @ =gUnk_Sio_02018648
	ldr r3, [r0]
	movs r2, #6
	ldrsb r2, [r3, r2]
	movs r0, #1
	...
	b .L02015EBE
	.align 2, 0
.L02015E8C: .4byte gUnk_Sio_02018648
.L02015E90:
...
func_common_02015DB4: @ 0x02015F3C
	push {r4, r5, r6, lr}
	adds r4, r0, #0
	ldr r3, .L02015FA4 @ =gUnk_Sio_02018648
	ldr r2, [r3]
...
.L02015F84:
	...
	bx r0
	.align 2, 0
.L02015FA4: .4byte gUnk_Sio_02018648
...
func_common_02015E28: @ 0x02015FB0
	push {r4, r5, r6, r7, lr}
	adds r7, r0, #0
	ldr r0, .L02015FFC @ =gUnk_Sio_02018648
	ldr r3, [r0]
	...
	b .L0201600A
	.align 2, 0
.L02015FFC: .4byte gUnk_Sio_02018648
...
func_common_02015E88: @ 0x02016010
	...
	movs r0, #1
	str r0, [r6]
	ldr r4, .L020160B0 @ =gUnk_Sio_02018648
	ldr r1, [r4]
...
.L020160B0: .4byte gUnk_Sio_02018648
