...
.L02015684:
	...
	adds r4, #7
	lsls r4, r4, #3
	ldr r0, .L020156F0 @ =gUnk_Sio_06_03001C30
	lsls r5, r6, #1
	adds r0, r5, r0
	ldrh r2, [r0]
	adds r0, r4, #0
	...
	movs r3, #4
	bl DebugPutObjNumber
	ldr r0, .L020156F4 @ =gUnk_Sio_06_03001CC8
	adds r5, r5, r0
	ldrh r2, [r5]
	adds r0, r4, #0
	movs r1, #0x78
...
.L020156F0: .4byte gUnk_Sio_06_03001C30
.L020156F4: .4byte gUnk_Sio_06_03001CC8
.L020156F8:
	cmp r0, #0x2e
	beq .L0201570C
	cmp r0, #0x2e
...
func_common_02015A3C: @ 0x02015B64
	...
	adds r4, r5, r1
	ldr r2, .L02015C0C @ =gUnk_Sio_02030080
	lsls r0, r3, #1
	adds r0, r0, r2
	strh r1, [r0]
	adds r3, #1
...
.L02015C0C: .4byte gUnk_Sio_02030080
...
func_06_02015C5C: @ 0x02015C5C
	...
	b .L02015D86
.L02015C8E:
	ldr r0, .L02015CE0 @ =gUnk_Sio_02030480
	ldrh r2, [r4]
	lsls r1, r2, #3
	adds r1, r3, r1
	adds r1, r1, r0
...
.L02015CE0: .4byte gUnk_Sio_02030480
...
.L02015D3E:
	...
	ands r0, r1
	strh r0, [r2]
	ldr r1, .L02015D78 @ =gUnk_Sio_06_03002E58
	adds r1, r4, r1
	ldrh r0, [r1]
	adds r0, #1
	strh r0, [r1]
	ldr r1, .L02015D7C @ =gUnk_Sio_06_03001CC8
	adds r1, r4, r1
	ldrh r0, [r1]
	adds r0, #1
	strh r0, [r1]
...
.L02015D78: .4byte gUnk_Sio_06_03002E58
.L02015D7C: .4byte gUnk_Sio_06_03001CC8
.L02015D80:
	adds r0, r6, #6
	cmp r0, r1
	ble .L02015D8C
...
.L02015E0E:
	...
	beq .L02015E4C
.L02015E1C:
	ldr r1, .L02015E44 @ =gUnk_Sio_06_03001C30
	mov r0, r8
	asrs r2, r0, #0x17
	adds r1, r2, r1
	ldrh r0, [r1]
	adds r0, #1
	strh r0, [r1]
	ldr r1, .L02015E48 @ =gUnk_Sio_06_03001CC8
	adds r2, r2, r1
	ldrh r0, [r2]
	adds r0, #1
	strh r0, [r2]
...
.L02015E44: .4byte gUnk_Sio_06_03001C30
.L02015E48: .4byte gUnk_Sio_06_03001CC8
.L02015E4C:
	mov r2, r8
	asrs r0, r2, #0x17
	ldr r3, .L02015E70 @ =gUnk_Sio_06_03001CC8
	adds r0, r0, r3
	ldrh r1, [r0]
	adds r1, #1
	strh r1, [r0]
...
.L02015E5E:
	...
	bx r1
	.align 2, 0
.L02015E70: .4byte gUnk_Sio_06_03001CC8
...
.L02015F04:
	movs r4, #0
	ldr r6, .L02015F34 @ =gUnk_Sio_02030480
...
.L02015F2C:
	...
	bx r1
	.align 2, 0
.L02015F34: .4byte gUnk_Sio_02030480
