...
func_02014DF4: @ 0x02014DF4
	...
	movs r3, #0
	str r3, [r0]
	ldr r2, .L02014F50 @ =gUnk_Sio_02018648
	ldr r0, [r2]
	movs r1, #0
	strh r3, [r0, #0x22]
	strh r3, [r0, #0x24]
...
.L02014E4E:
	...
	movs r2, #0
	ldr r3, .L02014F50 @ =gUnk_Sio_02018648
.L02014E82:
	adds r0, r4, r5
	strb r2, [r0]
	ldr r0, [r3]
	...
	ble .L02014E82
	movs r3, #0
	ldr r5, .L02014F50 @ =gUnk_Sio_02018648
	movs r1, #0
	movs r2, #0x9a
	lsls r2, r2, #1
.L02014EA0:
...
.L02014EAC:
	...
	ble .L02014EA0
	movs r3, #0
	ldr r4, .L02014F50 @ =gUnk_Sio_02018648
	mov ip, r4
	movs r5, #0
	movs r7, #0x8c
...
.L02014F50: .4byte gUnk_Sio_02018648
...
func_02014F80: @ 0x02014F80
	push {r4, lr}
	ldr r2, .L02014FDC @ =gUnk_Sio_02018648
	ldr r0, [r2]
	movs r4, #0
	strb r4, [r0]
	ldr r0, [r2]
	...
	bx r0
	.align 2, 0
.L02014FDC: .4byte gUnk_Sio_02018648
...
func_common_02014FE8: @ 0x02014FE8
	...
	strh r3, [r0]
	ldr r2, .L0201504C @ =gUnk_Sio_03001C34
	ldr r1, .L02015050 @ =0x03001C30
	movs r0, #0
	str r0, [r1]
	str r0, [r2]
	ldr r1, .L02015054 @ =gSioStateId
	str r0, [r1]
...
.L0201504C: .4byte gUnk_Sio_03001C34
.L02015050: .4byte 0x03001C30
.L02015054: .4byte gSioStateId
...
func_common_02015064: @ 0x02015064
	...
	movs r0, #0
	strh r0, [r1]
	ldr r2, .L020150AC @ =gUnk_Sio_03001C34
	ldr r1, .L020150B0 @ =0x03001C30
	movs r0, #0
	str r0, [r1]
	str r0, [r2]
	ldr r1, .L020150B4 @ =gSioStateId
	str r0, [r1]
...
.L020150AC: .4byte gUnk_Sio_03001C34
.L020150B0: .4byte 0x03001C30
.L020150B4: .4byte gSioStateId
...
func_common_020150C4: @ 0x020150C4
	...
	movs r0, #0
	mov sb, r0
	ldr r0, .L02015158 @ =gUnk_Sio_03001C34
	movs r2, #1
	str r2, [r0]
	ldr r1, .L0201515C @ =gUnk_Sio_02018648
	ldr r0, [r1]
	mov r3, sb
	strb r3, [r0, #0x1e]
...
.L0201512E:
	...
	cmp r0, sl
	beq .L0201517C
	ldr r2, .L0201515C @ =gUnk_Sio_02018648
	ldr r0, [r2]
	adds r0, #0xb
	adds r1, r0, r5
	ldrb r0, [r1]
...
.L0201514A:
	...
	b .L020151B6
	.align 2, 0
.L02015158: .4byte gUnk_Sio_03001C34
.L0201515C: .4byte gUnk_Sio_02018648
...
.L0201517C:
	...
	cmp r0, #1
	bne .L020151B6
	ldr r0, .L020151A8 @ =gUnk_Sio_02018648
	ldr r1, [r0]
	adds r0, r1, #0
	adds r0, #0x12
	adds r0, r0, r7
	...
	b .L020151B6
	.align 2, 0
.L020151A8: .4byte gUnk_Sio_02018648
.L020151AC:
	adds r0, r1, #0
	adds r0, #0x1a
	adds r0, r0, r5
	...
	strb r1, [r0]
.L020151B6:
	ldr r0, .L0201520C @ =gUnk_Sio_02018648
	mov r8, r0
	ldr r6, [r0]
	adds r3, r6, #0
	adds r3, #0x12
	...
	b .L020152E8
	.align 2, 0
.L0201520C: .4byte gUnk_Sio_02018648
...
.L020152CE:
	...
	cmp r3, #0
	bne .L020152E8
	ldr r0, .L02015308 @ =gUnk_Sio_02018648
	ldr r0, [r0]
...
.L02015308: .4byte gUnk_Sio_02018648
...
func_common_02015438: @ 0x02015438
	push {r4, r5, r6, lr}
	sub sp, #4
	ldr r0, .L02015474 @ =gUnk_Sio_02018648
	ldr r2, [r0]
	ldrh r1, [r2, #4]
	adds r5, r0, #0
	cmp r1, #4
...
.L02015452:
	...
	b .L020154E0
	.align 2, 0
.L02015474: .4byte gUnk_Sio_02018648
.L02015478:
	cmp r0, #3
	bne .L020154E0
	ldrb r0, [r1, #0x1e]
...
.L02015492:
	ldr r4, .L02015504 @ =gUnk_Sio_02018648
	ldr r0, [r4]
	ldrb r0, [r0, #1]
	cmp r0, #0
	beq .L020154B8
...
.L020154B8:
	movs r4, #0
	ldr r5, .L02015504 @ =gUnk_Sio_02018648
.L020154BC:
	ldr r0, .L02015504 @ =gUnk_Sio_02018648
	ldr r1, [r0]
	adds r0, r1, #0
	adds r0, #0x1a
	adds r0, r0, r4
...
.L020154E0:
	...
	b .L02015578
	.align 2, 0
.L02015504: .4byte gUnk_Sio_02018648
.L02015508:
	mov r0, sp
	...
	strb r6, [r0]
.L02015536:
	ldr r2, .L02015550 @ =gUnk_Sio_02018648
	ldr r1, [r2]
	ldrb r0, [r1, #0x10]
	adds r0, #1
	strb r0, [r1, #0x10]
	...
	b .L02015578
	.align 2, 0
.L02015550: .4byte gUnk_Sio_02018648
.L02015554:
	subs r0, #2
	lsls r0, r0, #0x18
	lsrs r0, r0, #0x18
...
func_common_020155AC: @ 0x020155AC
	push {r4, r5, r6, r7, lr}
	ldr r0, .L020155F8 @ =gUnk_Sio_02018648
	ldr r2, [r0]
	ldrb r1, [r2, #1]
	cmp r1, #1
	beq .L020155BA
...
.L020155C8:
	lsls r4, r7, #0x18
	asrs r0, r4, #0x18
	ldr r5, .L020155F8 @ =gUnk_Sio_02018648
	ldr r1, [r5]
	adds r1, #0x32
...
.L020155F2:
	...
	b .L020158C2
	.align 2, 0
.L020155F8: .4byte gUnk_Sio_02018648
.L020155FC:
	cmp r0, #0x2e
	beq .L02015610
	cmp r0, #0x2e
...
.L0201560A:
	...
	b .L020158C2
.L02015610:
	ldr r5, .L02015664 @ =gUnk_Sio_02018648
	ldr r2, [r5]
	adds r4, r2, #0
	adds r4, #0x32
	ldrb r0, [r4]
...
.L02015630:
	...
	b .L020155C8
	.align 2, 0
.L02015664: .4byte gUnk_Sio_02018648
...
.L020156B4:
	...
	bne .L020156E4
.L020156C2:
	ldr r0, .L020156DC @ =gUnk_Sio_02018648
	ldr r2, [r0]
	movs r0, #6
	ldrsb r0, [r2, r0]
	cmp r0, #0
...
.L020156D0:
	...
	b .L02015704
	.align 2, 0
.L020156DC: .4byte gUnk_Sio_02018648
.L020156E0: .4byte 0x03002E40
.L020156E4:
	ldr r0, .L02015710 @ =gUnk_Sio_02018648
	ldr r1, [r0]
	movs r0, #6
	ldrsb r0, [r1, r0]
	cmp r0, #0
...
.L02015708:
	...
	b .L020158C2
	.align 2, 0
.L02015710: .4byte gUnk_Sio_02018648
...
.L02015764:
	ldr r0, .L02015778 @ =gUnk_Sio_02018648
	ldr r2, [r0]
	movs r0, #1
	ldrb r5, [r5, #1]
	lsls r0, r5
	...
	b .L020158C2
	.align 2, 0
.L02015778: .4byte gUnk_Sio_02018648
.L0201577C:
	ldr r6, .L02015818 @ =gUnk_Sio_02018648
	ldr r3, [r6]
	adds r0, r3, #0
	adds r0, #0x2e
	ldrb r0, [r0]
...
.L020157B4:
	...
	b .L020158C2
	.align 2, 0
.L02015818: .4byte gUnk_Sio_02018648
...
.L02015824:
	...
	cmp r0, #0
	bne .L020158C2
	ldr r4, .L02015860 @ =gUnk_Sio_02018648
	ldr r0, [r4]
	movs r1, #6
	ldrsb r1, [r0, r1]
	adds r0, #0xb
	...
	b .L02015880
	.align 2, 0
.L02015860: .4byte gUnk_Sio_02018648
.L02015864:
	ldrb r0, [r5, #2]
	bl func_common_0201592C
	lsls r0, r0, #0x18
	cmp r0, #0
	bne .L020158C2
	ldr r2, .L02015888 @ =gUnk_Sio_02018648
	ldr r0, [r2]
	adds r0, #0xb
	ldrh r5, [r5, #2]
	adds r0, r0, r5
...
.L02015880:
	...
	b .L020158C2
	.align 2, 0
.L02015888: .4byte gUnk_Sio_02018648
.L0201588C:
	ldr r3, .L020158B8 @ =gUnk_Sio_02018648
	ldr r1, [r3]
	adds r1, #0xb
	ldrh r0, [r5, #2]
	adds r1, r1, r0
	...
	b .L020158C2
	.align 2, 0
.L020158B8: .4byte gUnk_Sio_02018648
.L020158BC:
	ldrb r0, [r5, #1]
...
func_common_0201592C: @ 0x0201592C
	lsls r0, r0, #0x18
	lsrs r0, r0, #0x18
	ldr r1, .L02015944 @ =gUnk_Sio_02018648
	ldr r1, [r1]
	ldrb r1, [r1, #9]
	asrs r1, r0
	movs r0, #1
	...
	b .L0201594A
	.align 2, 0
.L02015944: .4byte gUnk_Sio_02018648
.L02015948:
	movs r0, #1
.L0201594A:
	bx lr
...
func_common_0201594C: @ 0x0201594C
	lsls r0, r0, #0x18
	lsrs r0, r0, #0x18
	ldr r1, .L02015964 @ =gUnk_Sio_02018648
	ldr r1, [r1]
	ldrb r1, [r1, #8]
	asrs r1, r0
	movs r0, #1
	...
	b .L0201596A
	.align 2, 0
.L02015964: .4byte gUnk_Sio_02018648
.L02015968:
	movs r0, #1
.L0201596A:
	bx lr
...
func_common_0201596C: @ 0x0201596C
	push {r4, lr}
	ldr r2, .L02015998 @ =gUnk_Sio_02018648
	ldr r3, [r2]
	ldrh r1, [r3, #2]
	movs r0, #0
	strh r0, [r3, #2]
	...
	b .L020159A8
	.align 2, 0
.L02015998: .4byte gUnk_Sio_02018648
...
func_common_020159C0: @ 0x020159C0
	ldr r0, .L020159DC @ =gUnk_Sio_02018648
	ldr r0, [r0]
	...
	b .L020159EC
	.align 2, 0
.L020159DC: .4byte gUnk_Sio_02018648
...
func_common_020159F0: @ 0x020159F0
	...
	movs r2, #0
	movs r1, #0
	ldr r4, .L02015A30 @ =gUnk_Sio_02018648
	ldr r0, [r4]
	adds r3, r0, #0
	adds r3, #0xb
.L020159FE:
...
.L02015A2A:
	...
	b .L02015A36
	.align 2, 0
.L02015A30: .4byte gUnk_Sio_02018648
.L02015A34:
	movs r0, #0
.L02015A36:
	pop {r4}
...
func_common_02015CEC: @ 0x02015CEC
	push {r4, lr}
	adds r4, r0, #0
	ldr r0, .L02015D04 @ =gUnk_Sio_02018648
	ldr r3, [r0]
	movs r2, #6
	ldrsb r2, [r3, r2]
	movs r0, #1
	...
	b .L02015D36
	.align 2, 0
.L02015D04: .4byte gUnk_Sio_02018648
.L02015D08:
...
func_common_02015DB4: @ 0x02015DB4
	push {r4, r5, r6, lr}
	adds r4, r0, #0
	ldr r3, .L02015E1C @ =gUnk_Sio_02018648
	ldr r2, [r3]
...
.L02015DFC:
	...
	bx r0
	.align 2, 0
.L02015E1C: .4byte gUnk_Sio_02018648
...
func_common_02015E28: @ 0x02015E28
	push {r4, r5, r6, r7, lr}
	adds r7, r0, #0
	ldr r0, .L02015E74 @ =gUnk_Sio_02018648
	ldr r3, [r0]
	...
	b .L02015E82
	.align 2, 0
.L02015E74: .4byte gUnk_Sio_02018648
...
func_common_02015E88: @ 0x02015E88
	...
	movs r0, #1
	str r0, [r6]
	ldr r4, .L02015F28 @ =gUnk_Sio_02018648
	ldr r1, [r4]
...
.L02015F28: .4byte gUnk_Sio_02018648
