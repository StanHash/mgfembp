...
OnVBlank: @ 0x0201447C
	...
	strh r1, [r0]
	bl IncGameTime
	ldr r0, .L020144BC @ =gProcTreeRoots
	ldr r1, [r0]
	adds r0, r1, #0
	bl Proc_Run
	bl SyncLoOam
...
.L020144BC: .4byte gProcTreeRoots
...
OnMain: @ 0x020144C4
	...
	bl RefreshKeySt
	bl ClearSprites
	ldr r0, .L0201451C @ =gProcTreeRoots
	ldr r1, [r0, #4]
	adds r0, r1, #0
	bl Proc_Run
	ldr r0, .L0201451C @ =gProcTreeRoots
...
.L0201451C: .4byte gProcTreeRoots
...
Checksum32_thm:
	...
	.byte 0x47, 0x41, 0x4D, 0x45, 0x43, 0x54, 0x52, 0x4C, 0x00, 0x00, 0x00, 0x00
