...
StartSpriteRefresher: @ 0x020143C0
	...
	b .L020143F4
	.align 2, 0
.L020143E4: .4byte .L02018304
.L020143E8:
	ldr r1, .L0201443C @ =.L02018304
	adds r0, r1, #0
	movs r1, #3
	bl SpawnProc
	str r0, [r7, #0x10]
...
.L02014588: .4byte .L02018314

	thumb_func_start GetMainProc
GetMainProc: @ 0x0201458C
	push {r7, lr}
	mov r7, sp
	ldr r1, .L020145A0 @ =.L02018314
	adds r0, r1, #0
	bl FindProc
	adds r1, r0, #0
	adds r0, r1, #0
...
.L0201489A:
	...
	ldr r0, .L020148E4 @ =.L02018354
	ldr r0, [r0]
	ldr r3, [r1]
	adds r1, r4, #0
	movs r2, #0x20
	bl _call_via_r3
	ldr r1, .L020148E8 @ =.L0201732C
	adds r0, r4, #0
	bl StringEquals
	lsls r0, r0, #0x18
	cmp r0, #0
...
.L020148E4: .4byte .L02018354
.L020148E8: .4byte .L0201732C
...
SramOffsetToAddr: @ 0x020149B4
	lsls r0, r0, #0x10
	lsrs r0, r0, #0x10
	ldr r1, .L020149C4 @ =.L02018354
	ldr r1, [r1]
	adds r1, r1, r0
	adds r0, r1, #0
	bx lr
	.align 2, 0
.L020149C4: .4byte .L02018354

	thumb_func_start SramAddrToOffset
SramAddrToOffset: @ 0x020149C8
	ldr r1, .L020149D4 @ =.L02018354
	ldr r1, [r1]
	subs r0, r0, r1
	lsls r0, r0, #0x10
	lsrs r0, r0, #0x10
...
func_common_0201533C: @ 0x0201533C
	push {r4, lr}
	ldr r0, .L02015374 @ =.L02017984
	movs r1, #0
	movs r2, #0x20
	bl ApplyPaletteExt
	ldr r4, .L02015378 @ =.L02017334
	movs r0, #1
	bl GetBgChrOffset
	adds r1, r0, #0
	movs r0, #0xc0
	...
	bx r0
	.align 2, 0
.L02015374: .4byte .L02017984
.L02015378: .4byte .L02017334
.L0201537C: .4byte .L020177B8
...
.L020154B8:
	movs r4, #0
	ldr r5, .L02015504 @ =.L02018358
.L020154BC:
	ldr r0, .L02015504 @ =.L02018358
	ldr r1, [r0]
	adds r0, r1, #0
	adds r0, #0x1a
	adds r0, r0, r4
...
.L020156D0:
	...
	b .L02015704
	.align 2, 0
.L020156DC: .4byte .L02018358
.L020156E0: .4byte 0x03002E40
.L020156E4:
	ldr r0, .L02015710 @ =.L02018358
	ldr r1, [r0]
	movs r0, #6
	ldrsb r0, [r1, r0]
	cmp r0, #0
...
.L02015764:
	...
	b .L020158C2
	.align 2, 0
.L02015778: .4byte .L02018358
.L0201577C:
	ldr r6, .L02015818 @ =.L02018358
	ldr r3, [r6]
	adds r0, r3, #0
	adds r0, #0x2e
	ldrb r0, [r0]
...
.L02015880:
	...
	b .L020158C2
	.align 2, 0
.L02015888: .4byte .L02018358
.L0201588C:
	ldr r3, .L020158B8 @ =.L02018358
	ldr r1, [r3]
	adds r1, #0xb
	ldrh r0, [r5, #2]
	adds r1, r1, r0
...
.L02016044: .4byte .L02018358
.L02016048: .4byte 0x000007C6
.L0201604C:
	movs r0, #0
	strb r0, [r6]
	ldrb r5, [r6, #1]
	ldr r4, .L020160B4 @ =.L02018358
	ldr r2, [r4]
	lsls r0, r5, #1
	adds r1, r2, #0
	adds r1, #0x26
...
func_common_02016114: @ 0x02016114
	ldr r1, .L02016120 @ =.L02018358
	ldr r1, [r1]
	adds r1, #0x21
	strb r0, [r1]
	bx lr
	.align 2, 0
.L02016120: .4byte .L02018358
...
func_common_02016504: @ 0x02016504
	...
	bx r0
	.align 2, 0
.L0201652C: .4byte .L0201837C

	thumb_func_start func_common_02016530
func_common_02016530: @ 0x02016530
	push {lr}
	ldr r0, .L0201654C @ =.L0201835C
	bl FindProc
	cmp r0, #0
	bne .L02016554
	ldr r0, .L02016550 @ =.L0201837C
	bl FindProc
	cmp r0, #0
	bne .L02016554
	movs r0, #0
	b .L02016556
	.align 2, 0
.L0201654C: .4byte .L0201835C
.L02016550: .4byte .L0201837C
.L02016554:
	movs r0, #1
.L02016556:
	pop {r1}
...
func_common_020166F8: @ 0x020166F8
	...
	movs r0, #0
	bl InitBgs
	ldr r0, .L02016768 @ =.L02017984
	movs r1, #0
	movs r2, #0x20
	bl ApplyPaletteExt
	ldr r4, .L0201676C @ =.L02017334
	movs r0, #1
	bl GetBgChrOffset
	adds r1, r0, #0
	movs r0, #0xc0
...
.L02016768: .4byte .L02017984
.L0201676C: .4byte .L02017334
.L02016770: .4byte .L020176E8
.L02016774: .4byte 0x0202B220
.L02016778: .4byte .L020183CC
.L0201677C: .4byte .L020183F4
.L02016780: .4byte .L020183A4
...
func_common_02016784: @ 0x02016784
	...
	adds r6, r0, #0
	movs r4, #0
	ldr r0, .L020167D0 @ =.L020183A4
	bl FindProc
	cmp r0, #0
	bne .L02016814
	movs r1, #0
	ldr r0, .L020167D4 @ =.L02018358
	ldr r0, [r0]
	adds r2, r0, #0
	adds r2, #0x1a
.L0201679E:
...
.L020167C6:
	...
	b .L02016814
	.align 2, 0
.L020167D0: .4byte .L020183A4
.L020167D4: .4byte .L02018358
.L020167D8:
...
SwiCpuFastSet: @ 0x02016A5C
	svc #0xc
	bx lr

	thumb_func_start SwiCpuSet
SwiCpuSet: @ 0x02016A60
	svc #0xb
	bx lr
.L02016A64:
	.byte 0x13, 0xDF, 0x70, 0x47, 0x12, 0xDF, 0x70, 0x47

	thumb_func_start SwiLZ77UnCompReadNormalWrite8bit
SwiLZ77UnCompReadNormalWrite8bit: @ 0x02016A6C
	svc #0x11
	bx lr
.L02016A70:
...
SwiSoftReset: @ 0x02016A78
	ldr r3, .L02016A88 @ =0x04000208
	movs r2, #0
	strb r2, [r3]
	ldr r1, .L02016A8C @ =0x03007F00
	mov sp, r1
	svc #1
	svc #0
	movs r0, r0
	.align 2, 0
.L02016A88: .4byte 0x04000208
.L02016A8C: .4byte 0x03007F00

	thumb_func_start SwiSoundBiasReset
SwiSoundBiasReset: @ 0x02016A90
	movs r0, #0
	svc #0x19
	bx lr
	.align 2, 0
...
ReadSramFastFunc: @ 0x02016AA8
	push {r4, r5, lr}
	adds r5, r0, #0
	adds r4, r1, #0
	adds r3, r2, #0
	ldr r2, .L02016AE0 @ =0x04000204
	ldrh r0, [r2]
	ldr r1, .L02016AE4 @ =0x0000FFFC
	ands r0, r1
	movs r1, #3
	orrs r0, r1
	strh r0, [r2]
...
.L02016AD8:
	...
	bx r0
	.align 2, 0
.L02016AE0: .4byte 0x04000204
.L02016AE4: .4byte 0x0000FFFC

	thumb_func_start WriteSramFast
WriteSramFast: @ 0x02016AE8
	push {r4, r5, lr}
	adds r5, r0, #0
	adds r4, r1, #0
	adds r3, r2, #0
...
VerifySramFastFunc: @ 0x02016B28
	push {r4, r5, lr}
	adds r5, r0, #0
	adds r4, r1, #0
	adds r3, r2, #0
	ldr r2, .L02016B5C @ =0x04000204
	ldrh r0, [r2]
	ldr r1, .L02016B60 @ =0x0000FFFC
	ands r0, r1
	movs r1, #3
	orrs r0, r1
	strh r0, [r2]
...
.L02016B4A:
	...
	b .L02016B6C
	.align 2, 0
.L02016B5C: .4byte 0x04000204
.L02016B60: .4byte 0x0000FFFC
.L02016B64:
	subs r3, #1
	cmp r3, r2
	bne .L02016B4A
...
SetSramFastFunc: @ 0x02016B74
	ldr r2, .L02016B88 @ =ReadSramFastFunc
	movs r0, #1
	eors r2, r0
	ldr r3, .L02016B8C @ =0x030002C0
	ldr r0, .L02016B90 @ =WriteSramFast
	ldr r1, .L02016B88 @ =ReadSramFastFunc
	subs r0, r0, r1
	lsls r0, r0, #0xf
	b .L02016BA0
	.align 2, 0
.L02016B88: .4byte ReadSramFastFunc
.L02016B8C: .4byte 0x030002C0
.L02016B90: .4byte WriteSramFast
.L02016B94:
	ldrh r0, [r2]
	strh r0, [r3]
	adds r2, #2
...
.L02016BA0:
	...
	cmp r1, #0
	bne .L02016B94
	ldr r1, .L02016BC0 @ =0x03002ED0
	ldr r0, .L02016BC4 @ =0x030002C1
	str r0, [r1]
	ldr r2, .L02016BC8 @ =VerifySramFastFunc
	movs r0, #1
	eors r2, r0
	ldr r3, .L02016BCC @ =0x03000220
	ldr r0, .L02016BD0 @ =SetSramFastFunc
	ldr r1, .L02016BC8 @ =VerifySramFastFunc
	subs r0, r0, r1
	lsls r0, r0, #0xf
	b .L02016BE0
	.align 2, 0
.L02016BC0: .4byte 0x03002ED0
.L02016BC4: .4byte 0x030002C1
.L02016BC8: .4byte VerifySramFastFunc
.L02016BCC: .4byte 0x03000220
.L02016BD0: .4byte SetSramFastFunc
.L02016BD4:
	ldrh r0, [r2]
	strh r0, [r3]
	adds r2, #2
...
.L02016BE0:
	...
	cmp r1, #0
	bne .L02016BD4
	ldr r1, .L02016BFC @ =0x03002ED4
	ldr r0, .L02016C00 @ =0x03000221
	str r0, [r1]
	ldr r2, .L02016C04 @ =0x04000204
	ldrh r0, [r2]
	ldr r1, .L02016C08 @ =0x0000FFFC
	ands r0, r1
	movs r1, #3
	orrs r0, r1
	strh r0, [r2]
	bx lr
	.align 2, 0
.L02016BFC: .4byte 0x03002ED4
.L02016C00: .4byte 0x03000221
.L02016C04: .4byte 0x04000204
.L02016C08: .4byte 0x0000FFFC

	thumb_func_start WriteAndVerifySramFast
WriteAndVerifySramFast: @ 0x02016C0C
	push {r4, r5, r6, r7, lr}
	adds r6, r0, #0
	adds r5, r1, #0
	adds r4, r2, #0
...
ClearOam_thm: @ 0x02016F88
	bx pc
	nop

	arm_func_start func_02016F8C
func_02016F8C: @ 0x02016F8C
	b ClearOam

	thumb_func_start Checksum32_thm
Checksum32_thm: @ 0x02016F90
	bx pc
	nop

	arm_func_start func_02016F94
func_02016F94: @ 0x02016F94
	b Checksum32
...
.L02017110:
	...
	.byte 0x00, 0x00, 0x00, 0x80, 0x00, 0x78, 0x00, 0x00, 0x10, 0x71, 0x01, 0x02, 0x5C, 0x03, 0x00, 0x03
	.byte 0x60, 0x03, 0x00, 0x03, 0x64, 0x03, 0x00, 0x03, 0x68, 0x03, 0x00, 0x03, 0x50, 0x03, 0x00, 0x03
	.byte 0x20, 0xA6, 0x02, 0x02, 0xFC, 0x79, 0x01, 0x02, 0xF8, 0x79, 0x01, 0x02, 0xFC, 0x03, 0x00, 0x03
	...
	.byte 0xD4, 0xCB, 0x02, 0x02, 0x0C, 0x7A, 0x01, 0x02, 0x74, 0x7A, 0x01, 0x02, 0x20, 0xA6, 0x02, 0x02
...
.L02017270:
	...
	.byte 0x00, 0x00, 0x00, 0x00, 0x90, 0xEF, 0x02, 0x02, 0x70, 0x72, 0x01, 0x02, 0x98, 0xEF, 0x02, 0x02
	.byte 0x7C, 0xCF, 0x02, 0x02, 0x20, 0xBA, 0x02, 0x02, 0x7C, 0xCF, 0x02, 0x02, 0x7C, 0xCF, 0x02, 0x02
	.byte 0x9C, 0xEF, 0x02, 0x02, 0xA0, 0xEF, 0x02, 0x02, 0x74, 0x7A, 0x01, 0x02, 0x20, 0xA6, 0x02, 0x02
	.byte 0x74, 0x82, 0x01, 0x02, 0x9C, 0xEF, 0x02, 0x02, 0xA0, 0xEF, 0x02, 0x02, 0x98, 0xEF, 0x02, 0x02
	...
	.byte 0x20, 0x1C, 0x00, 0x03, 0xA4, 0xF7, 0x02, 0x02, 0xA4, 0xF7, 0x02, 0x02, 0x04, 0x83, 0x01, 0x02
	.byte 0x04, 0x83, 0x01, 0x02, 0x47, 0x41, 0x4D, 0x45, 0x43, 0x54, 0x52, 0x4C, 0x00, 0x00, 0x00, 0x00
	.byte 0x5C, 0xCF, 0x02, 0x02, 0x30, 0x00, 0x00, 0x03, 0xF8, 0x79, 0x01, 0x02, 0x5C, 0xCF, 0x02, 0x02
	.byte 0x30, 0x00, 0x00, 0x03, 0xC5, 0x44, 0x01, 0x02, 0x7D, 0x44, 0x01, 0x02, 0x14, 0x83, 0x01, 0x02
	.byte 0x14, 0x83, 0x01, 0x02, 0x14, 0x83, 0x01, 0x02, 0x14, 0x83, 0x01, 0x02
.L0201732C:
...
.L02017984:
	...
	.byte 0x53, 0x52, 0x41, 0x4D, 0x5F, 0x46, 0x5F, 0x56, 0x31, 0x30, 0x32, 0x00, 0xA9, 0x6A, 0x01, 0x02
	.byte 0xC0, 0x02, 0x00, 0x03, 0xE9, 0x6A, 0x01, 0x02, 0xD0, 0x2E, 0x00, 0x03, 0xC1, 0x02, 0x00, 0x03
	.byte 0x29, 0x6B, 0x01, 0x02, 0x20, 0x02, 0x00, 0x03, 0x75, 0x6B, 0x01, 0x02, 0xD4, 0x2E, 0x00, 0x03
...
.L02018314:
	.byte 0x01, 0x00, 0x00, 0x00, 0xF4, 0x72, 0x01, 0x02, 0x0F, 0x00, 0x0B, 0x00
	.byte 0x00, 0x00, 0x00, 0x00, 0x15, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00
	.byte 0x35, 0x6A, 0x01, 0x02, 0x0E, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0B, 0x00, 0x00, 0x00
...
.L0201837C:
	...
	.byte 0x00, 0x00, 0x00, 0x00
.L020183A4:
	.byte 0x01, 0x00, 0x00, 0x00, 0xA4, 0x79, 0x01, 0x02, 0x15, 0x00, 0x00, 0x00
