...
func_common_02015A3C: @ 0x02015A3C
	...
	adds r4, r5, r1
	ldr r2, .L02015AE4 @ =gUnk_Sio_02030080
	lsls r0, r3, #1
	adds r0, r0, r2
	strh r1, [r0]
	adds r3, #1
...
.L02015AE4: .4byte gUnk_Sio_02030080
...
func_common_02015B34: @ 0x02015B34
	...
	cmp r1, r5
	beq .L02015C36
	ldr r0, .L02015BB4 @ =gUnk_Sio_02030480
	ldrh r2, [r4]
	lsls r1, r2, #3
	adds r1, r3, r1
	adds r1, r1, r0
...
.L02015BB4: .4byte gUnk_Sio_02030480
...
.L02015D7C:
	movs r4, #0
	ldr r6, .L02015DAC @ =gUnk_Sio_02030480
...
.L02015DA4:
	...
	bx r1
	.align 2, 0
.L02015DAC: .4byte gUnk_Sio_02030480
